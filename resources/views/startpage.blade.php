<x-base>
        ...
        <div class="header">
            <nav class="header__navbar navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container-fluid">
                    <a class="navbar-brand" href="{{ config('app.url') }}"> <img src="{{ asset('images/logo.svg') }}" alt="DFI Signal logo" class="header__logo" width="512" height="173" /> </a>
                </div>
            </nav>
        </div>
    </section>
    <section class="section">
        <div class="intro">
            <div class="intro__bg"> <img src="{{ asset('images/icon.svg') }}" width="173" height="173" alt="DFI Signal Icon" class="intro__icon" loading="lazy" /> </div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md">
                        <div class="phone">
                            <div class="phone__wrapper"> <img src="{{ asset('images/phone.png') }}" alt="" class="phone__phone" width="540" height="641" loading="lazy" /> <img src="{{ asset('images/screen.jpg') }}" alt="" class="phone__screen" loading="lazy" /> </div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section">
        <div class="about">
            <div class="container">
                <h2>Masternodes</h2>
                <p> Setup your DFI Signal and get informed on new minted blocks or if your masternodes follows the wrong fork. </p>
                <hr/>
                ...
                <p class="code">
                    &#47;link_mn &lt;OWNER_ADR &#47; OPERATOR_ADR &#47;
                    MN_ID&gt;
                </p>
                <p>
                ...
                <p class="code">
                    &#47;unlink_mn &lt;OWNER_ADR &#47; OPERATOR_ADR
                    &#47; MN_ID&gt;
                </p>
                ...
                <p class="code">&#47;sync</p>
                <p>
                    Use the sync with <a href="https://www.defichain-masternode-monitor.com/" target="_blank">Masternode Monitor</a>.
