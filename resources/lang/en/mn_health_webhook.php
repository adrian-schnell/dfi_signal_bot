...
return [
    ...
    'warnings' => [
        ...
        'logsize'          => "👉 *Logsize quite big*\r\nYour `debug.log` appears to be quite big with :value MB. Maybe your node has a problem... To prevent reaching a logsize of this size, it's recommended to setup logrotation for the debug.log file.",
